...
1. Clone repository
  ```
  git clone https://github.com/tagcoin/tag-faucet
  ```
...
5. Run faucet with `npm start`. TAG  Network faucet will be launched at `http://localhost:5000`
...
```
{
  ...
  "Ethereum": {
    ...
    "prod": {
      "rpc": "JSON RPC endpoint. For example, https://testnet.tagcash.com:8545",
